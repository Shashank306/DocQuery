...
function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-violet-200 flex items-center justify-center px-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md animate-fade-in-down">
